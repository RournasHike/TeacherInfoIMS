package com.mytest.teainfoims.aspect;

import com.mytest.teainfoims.annotation.RequiredPermission;
...
public class PermissionProxy {
     ...
     */
    @Around(value = "@annotation(com.mytest.teainfoims.annotation.RequiredPermission)")
