...
<div>
    ...
    <div style="width: 100%;">
        <#list data as d>
            <i class="layui-icon layui-icon-rate" onclick="changeCss(this)" value="${d.teachRoomName!''}" style="margin: 10px;padding: 2px;font-size: 24px;font-weight: 700">${d.teachRoomName!""}</i>
        </#list>
    </div>
...
<script>
    ...
    $('#transmit').on('click', function(){
        parent.$('#parentTeachRoomIframe').text(chooseVal);
        parent.layer.tips('Look here', '#parentTeachRoomIframe', {time: 5000});
