    ...
    <body class="childrenBody">
        <form class="layui-form" style="width:80%;">
            ...
            <div class="layui-form-item layui-row layui-col-xs12">
                ...
                <div class="layui-input-block">
                    <input type="text" class="layui-input userName"
                           lay-verify="required|username" name="teacherName" id="teacherName" maxlength="20" value="${(tea.teacherName)!}" placeholder="请输入用户名">
                </div>
            </div>
            ...
            <div class="layui-form-item layui-row layui-col-xs12">
                ...
                <div class="layui-input-block">
                    <input type="tel" class="layui-input userEmail"
                           lay-verify="required|phone" name="phone" value="${(tea.phone)!}" id="phone" placeholder="请输入手机号" maxlength="11">
                </div>
            </div>
            ...
            <div class="layui-form-item layui-row layui-col-xs12">
                ...
                <div class="layui-input-block">
                    <input type="email" class="layui-input userEmail"
                           lay-verify="required|email" name="email" value="${(tea.email)!}" id="email" placeholder="请输入邮箱">
                </div>
            </div>
