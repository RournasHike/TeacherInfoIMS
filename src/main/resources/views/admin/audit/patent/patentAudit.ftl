...
<div class="layui-container" >
    ...
    <div class="layui-row layui-col-space10">
        <div class="layui-col-md9">
            <div class="piddiv" style="display: none"><input type="hidden" id="patid" name="patid" value="${(patent.patid)!""}"></div>
            <table cellpadding="2px" cellspacing="4px" style="text-align: center" border="1px solid black" class="layui-table">
                ...
                <tr>
                    ...
                    <td class="rightcell">
                        <a style="color: blue;text-decoration: underline;" href="${ctx}/${(patent.paccessory)!""}">点此下载</a>
                    </td>
                </tr>
...
<script type="text/javascript" src="${ctx}/js/admin/audit/patent/patentAudit.js"></script>
</body>
</html>