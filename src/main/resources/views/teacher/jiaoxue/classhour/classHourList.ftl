...
<form class="layui-form" >
    ...
    <!--操作-->
    <script id="classHourListBar" type="text/html">
        <a class="layui-btn layui-btn-xs layui-btn-normal" id="classHourDetail" lay-event="classHourDetail">查看学时详情</a>
    </script>


</form>
<script type="text/javascript" src="${ctx}/js/teacher/jiaoxue/classhour/classHourList.js"></script>
<script>
    //JavaScript代码区域
