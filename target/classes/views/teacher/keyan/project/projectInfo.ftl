    ...
    <div class="layui-row layui-col-space10">
        <div class="layui-col-md9">
            <table style="border: 1px solid black" class="layui-table">
                ...
                <tr>
                    <td class="leftcell"><label>科研项目成果形式:</label></td>
                    <td class="rightcell">${(project.result)!""}</td>
                    <td class="leftcell"><label>附件:</label></td>
                    <td class="rightcell">
                        <a style="color: blue;text-decoration: underline;" href="${ctx}/${(project.paccessory)!""}">点此下载</a>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td colspan="2">
                        <#if project.paudit??>
                            <#assign audit="${project.paudit?string('1','0')}"/>
                            <#else >
